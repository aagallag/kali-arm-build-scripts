...
echo "Creating image file for Raspberry Pi3"
dd if=/dev/zero of=${basedir}/kali-$1-rpi3.img bs=1M count=$size
parted kali-$1-rpi3.img --script -- mklabel msdos
parted kali-$1-rpi3.img --script -- mkpart primary fat32 0 64
parted kali-$1-rpi3.img --script -- mkpart primary ext4 64 -1

# Set the partition variables
loopdevice=`losetup -f --show ${basedir}/kali-$1-rpi3.img`
...
# Deploy Nexmon firmware
cp ${basedir}/root/usr/src/nexmon/patches/bcm43438/7_45_41_26/nexmon/brcmfmac/brcmfmac.ko ${basedir}/root/root/
cp ${basedir}/root/usr/src/nexmon/patches/bcm43438/7_45_41_26/nexmon/brcmfmac43430-sdio.bin ${basedir}/root/lib/firmware/brcm/
...
# soon.
echo "Generating sha1sum for kali-$1-rpi3.img"
sha1sum kali-$1-rpi3.img > ${basedir}/kali-$1-rpi3.img.sha1sum
# Don't pixz on 32bit, there isn't enough memory to compress the images.
MACHINE_TYPE=`uname -m`
if [ ${MACHINE_TYPE} == 'x86_64' ]; then
echo "Compressing kali-$1-rpi3.img"
pixz ${basedir}/kali-$1-rpi3.img ${basedir}/kali-$1-rpi3.img.xz
rm ${basedir}/kali-$1-rpi3.img
echo "Generating sha1sum for kali-$1-rpi3.img.xz"
sha1sum kali-$1-rpi3.img.xz > ${basedir}/kali-$1-rpi3.img.xz.sha1sum
fi
